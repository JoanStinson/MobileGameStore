...
namespace Ubisoft.UIProgrammerTest.Data
{
    ...
    public class ShopPackData
    {
        ...
        public static ShopPackData CreateFromJson(JSONNode data)
        {
            ...
            if (data.HasKey("type"))
            {
                Utils.Utils.EnumTryParse(data["type"], true, out newObject.m_type);
            }
            ...
            {
                Utils.Utils.EnumTryParse(data["currency"], true, out newObject.m_currency);
            }
            ...
            {
                JSONArray itemsData = data["items"].AsArray;
